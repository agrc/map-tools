define(['dojo/text!agrc/widgets/locate/templates/FindRouteMilepost.html', 'dojo/_base/declare', 'dojo/_base/lang', 'dojo/_base/Color', 'dojo/dom-class', 'dojo/string', 'dojo/io/script', 'dojo/when', 'dojo/query', 'dijit/_WidgetBase', 'dijit/_TemplatedMixin', 'dijit/_WidgetsInTemplateMixin', 'esri/layers/GraphicsLayer', 'esri/symbols/SimpleMarkerSymbol', 'esri/graphic', 'esri/geometry/Point', 'esri/geometry/scaleUtils'], function (template, declare, lang, Color, domClass, string, dojoScript, when, query, _WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, GraphicsLayer, SimpleMarkerSymbol, Graphic, Point, scaleUtils) {
    return declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin], {
        ...
        _onFindClick: function _onFindClick() {
            // summary:
            //      description
        ...
        _invokeWebService: function _invokeWebService() {
            // summary:
            //      description
            // returned: Deferred
            ...
            var url = '//api.mapserv.utah.gov/api/v1/geocode/milepost/${route}/${milepost}?' + 'apiKey=${key}&spatialReference=${sr}';
            var params = {
        ...
        _onXHRSuccess: function _onXHRSuccess(result, noZoom) {
            // summary:
        ...
        _onXHRFailure: function _onXHRFailure() {
            // summary:
            //      description
...
//# sourceMappingURL=FindRouteMilepost.js.map
